...
@section('page-title', 'Investment Responses')

@section('header-icon')
<i class="bx bx-chart text-gray-600 text-lg sm:text-xl"></i>
@endsection
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                                ...
                                <div class="flex-1">
                                    ...
                                    @if($response->investment_amount)
                                        <div class="mb-2">
                                            ...
                                            <span class="text-sm text-gray-600">${{ number_format($response->investment_amount, 2) }}</span>
                                        </div>
                                    @endif
        ...
        @else
            <div class="p-12 text-center">
                <i class="bx bx-message-square-dots text-gray-400 text-4xl mb-4"></i>
                <h3 class="text-lg font-medium text-gray-900 mb-2">No responses yet</h3>
                <p class="text-gray-500">Responses to this investment message will appear here.</p>
            </div>
        @endif
    </div>
</div>
