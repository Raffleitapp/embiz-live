...
@section('header-actions')
    <div class="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
        ...
        <a href="{{ route('dashboard.add-member') }}"
            class="bg-teal-600 text-white px-3 sm:px-4 py-2 rounded-lg hover:bg-teal-700 transition-colors flex items-center space-x-2 text-sm sm:text-base w-full sm:w-auto justify-center">
    ...
    <div class="p-3 sm:p-4 lg:p-6">
        ...
        <div
            ...
            <div
                ...
                <button
                    class="px-3 sm:px-4 py-2 text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-50 text-sm flex items-center w-full sm:w-auto justify-center">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-3">
                                    @if ($user->profile && $user->profile->is_founding_member)
                                        <span
                                            class="inline-flex items-center px-2 py-0.8 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                            Founding Member
                                        </span>
                                    @else
                                        <span
    ...
    <script>
        ...
        document.getElementById('searchInput').addEventListener('input', function() {
            ...
            rows.forEach(row => {
                ...
                'td:nth-child(2)'); // Changed from 3 to 2 since User ID column is commented out
                if (nameCell) {
